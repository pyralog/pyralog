//! DLog Core - Fundamental abstractions for distributed logging
//!
//! This module provides the core types, traits, and interfaces for the DLog distributed log system.
